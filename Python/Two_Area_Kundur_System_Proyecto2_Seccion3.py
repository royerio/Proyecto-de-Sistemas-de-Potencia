...
#modos de oscilacion de la seccion 3.c

#Autovectores se separan con respecto a los modos de oscilacion:


#Se crean los cinco vectores de las formas de modo correspondientes a cada uno de los modos de oscilación de la seccion 3.C
#Se llenan con los autovectores derechos correspondientes a la frecuencia de cada uno de los cuatro generadores
...
# Se crea un vector con todos los modos anteriores para mas facil manipulacion.
modes = [Vr1, Vr2, Vr3, Vr4, Vr5]




#hay que crear un bucle para todos los modos, entonces se agrega un contador "k"

k=1


#Se crea un bucle para transformar el vector "mode" en un vector de vectores de magnitudes
for mode in modes:
    max_magnitude = 0
    for entry in mode:
        magnitude = abs(entry)
...
# Normalizar "mode" con respecto a la norma más alta
    mode = [x/max_magnitude for x in mode]
